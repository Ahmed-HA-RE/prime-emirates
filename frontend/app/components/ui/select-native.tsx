...
const SelectNative = ({
  ...
  return (
    <div className='relative flex'>
      ...
      {!props.multiple && (
        <span className='pointer-events-none absolute inset-y-0 end-0 flex h-full w-9 items-center justify-center text-black peer-disabled:opacity-50 peer-aria-invalid:text-destructive/80'>
